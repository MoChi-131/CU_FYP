...
# Input PDF
pdf_path = r"C:\Users\awang\OneDrive\桌面\CU\Year 3\FYP\OCR.space API\input\sample_short.pdf"
...
# Output
output= r"C:\Users\awang\OneDrive\桌面\CU\Year 3\FYP\OCR.space API\output_csv\output.csv"
...
with open(output, mode="w", newline="", encoding="utf-8") as csv_file:
    ...
    for i, page in enumerate(pages):
        ...
        image_path = fr"C:\Users\awang\OneDrive\桌面\CU\Year 3\FYP\OCR.space API\input/page_{i+1}.png"
