...
# File names
input_total = r"C:\Users\awang\OneDrive\桌面\CU\Year 3\FYP\OCR.space API\output_csv\Total.csv"
input_detail =r"C:\Users\awang\OneDrive\桌面\CU\Year 3\FYP\OCR.space API\output_csv\Details.csv"
excel_file = 'extracted_data.xlsx'

# Copy data from extracting module
detail_data_dict = extracting.detail_data_dict.copy()
total_data_dict = extracting.total_data_dict.copy()
